...
contract Vault {
    ...
    // create a deposit function that mints tokens to the user equal to the amount of ETH the user hase sent
    // create a redeem function that burns tokens form the user and sends the user ETH
    ...
    function redeem(uint256 _amount) external {
        ...
        // 1. burn the tokens form the user
